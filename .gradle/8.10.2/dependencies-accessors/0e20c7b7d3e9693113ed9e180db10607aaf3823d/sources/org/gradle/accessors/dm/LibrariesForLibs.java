...
public class LibrariesForLibs extends AbstractExternalDependencyFactory {
    ...
    private final OlaLibraryAccessors laccForOlaLibraryAccessors = new OlaLibraryAccessors(owner);
    ...
    /**
     * Dependency provider for <b>billing</b> with <b>com.google.androidbrowserhelper:billing</b> coordinates and
    ...
    /**
     * Group of libraries at <b>ola</b>
     */
    public OlaLibraryAccessors getOla() {
        return laccForOlaLibraryAccessors;
    }
    ...
    public static class AndroidPluginLibraryAccessors extends SubDependencyFactory {
        ...
        private final AndroidPluginMarkerviewLibraryAccessors laccForAndroidPluginMarkerviewLibraryAccessors = new AndroidPluginMarkerviewLibraryAccessors(owner);
        ...
        /**
         * Group of libraries at <b>android.plugin.markerview</b>
         */
        public AndroidPluginMarkerviewLibraryAccessors getMarkerview() {
            return laccForAndroidPluginMarkerviewLibraryAccessors;
        }
    ...
    public static class AndroidPluginMarkerviewLibraryAccessors extends SubDependencyFactory {

        public AndroidPluginMarkerviewLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Dependency provider for <b>v9</b> with <b>org.maplibre.gl:android-plugin-markerview-v9</b> coordinates and
         * with version reference <b>androidPluginAnnotationV9</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getV9() {
            return create("android.plugin.markerview.v9");
        }
    ...
    public static class AndroidxCredentialsLibraryAccessors extends SubDependencyFactory implements DependencyNotationSupplier {
        ...
        /**
         * Dependency provider for <b>v120alpha04</b> with <b>androidx.credentials:credentials</b> coordinates and
         * with version reference <b>androidxCredentials</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getV120alpha04() {
            return create("androidx.credentials.v120alpha04");
        }

        /**
         * Dependency provider for <b>v150rc01</b> with <b>androidx.credentials:credentials</b> coordinates and
         * with version reference <b>credentialsVersion</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getV150rc01() {
            return create("androidx.credentials.v150rc01");
        }
    ...
    public static class AndroidxCredentialsPlayServicesLibraryAccessors extends SubDependencyFactory {
        private final AndroidxCredentialsPlayServicesAuthLibraryAccessors laccForAndroidxCredentialsPlayServicesAuthLibraryAccessors = new AndroidxCredentialsPlayServicesAuthLibraryAccessors(owner);

        public AndroidxCredentialsPlayServicesLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Group of libraries at <b>androidx.credentials.play.services.auth</b>
         */
        public AndroidxCredentialsPlayServicesAuthLibraryAccessors getAuth() {
            return laccForAndroidxCredentialsPlayServicesAuthLibraryAccessors;
        }

    }

    public static class AndroidxCredentialsPlayServicesAuthLibraryAccessors extends SubDependencyFactory {

        public AndroidxCredentialsPlayServicesAuthLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Dependency provider for <b>v150rc01</b> with <b>androidx.credentials:credentials-play-services-auth</b> coordinates and
         * with version reference <b>credentialsPlayServicesAuth</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getV150rc01() {
            return create("androidx.credentials.play.services.auth.v150rc01");
        }
    ...
    public static class OlaLibraryAccessors extends SubDependencyFactory {
        private final OlaMapsLibraryAccessors laccForOlaMapsLibraryAccessors = new OlaMapsLibraryAccessors(owner);

        public OlaLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Group of libraries at <b>ola.maps</b>
         */
        public OlaMapsLibraryAccessors getMaps() {
            return laccForOlaMapsLibraryAccessors;
        }

    }

    public static class OlaMapsLibraryAccessors extends SubDependencyFactory {

        public OlaMapsLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Dependency provider for <b>sdk</b> with <b>com.ola.maps:ola-maps-sdk</b> coordinates and
         * with version reference <b>olaMapsSdk</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getSdk() {
            return create("ola.maps.sdk");
        }
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>androidPluginAnnotationV9</b> with value <b>1.0.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>androidSdk</b> with value <b>10.0.2</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>androidxCredentials</b> with value <b>1.2.0-alpha04</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getAndroidxCredentials() { return getVersion("androidxCredentials"); }
        ...
        /**
         * Version alias <b>billing</b> with value <b>1.0.0-alpha11</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>checkout</b> with value <b>1.6.41</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>credentialsPlayServicesAuth</b> with value <b>1.5.0-rc01</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>credentialsVersion</b> with value <b>1.5.0-rc01</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>olaMapsSdk</b> with value <b>1.0.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getOlaMapsSdk() { return getVersion("olaMapsSdk"); }
